...
const ChooseSubject = ({ situation }) => {
    ...
    if (loading) {
        ...
        return <div>
            <h1>Sorry all SubDeparts have Doctors assigned already</h1>
                    ...
                    <Table aria-label="sclasses table">
                        <TableHead>
                            <StyledTableRow>
                                ...
                                <StyledTableCell align="center">SubDepartment Name</StyledTableCell>
                                <StyledTableCell align="center">Sub Code</StyledTableCell>
